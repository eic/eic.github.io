...
tutorials:
  ...
  - title: "Analysis and simulation output"
    ...
    image: "/assets/images/tutorials/tutorial-analysis.png"
    resources:
      - label: "1"
  ...
  - title: "Simulating detectors"
    ...
    image: "/assets/images/tutorials/tutorial-geometry.png"
    resources:
  ...
  - title: "Getting started with physics analysis"
    ...
    image: "/assets/images/tutorials/tutorial-physics-analysis.png"
    resources:
  ...
  - title: "Inclusive kinematics reconstruction"
    ...
    image: "/assets/images/tutorials/tutorial-kinematics.png"
    resources:
  ...
  - title: "Developing benchmarks"
    ...
    image: "/assets/images/tutorials/tutorial-benchmarks.png"
  ...
  - title: "Reconstruction framework"
    ...
    summary: "eicrecon in a nutshell. <br> JANA2 framework , Plugins, Factories, and Algorithms"
